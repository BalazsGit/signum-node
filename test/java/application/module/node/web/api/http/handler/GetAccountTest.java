...
class GetAccountTest extends AbstractUnitTest {
    ...
    public void processRequest() throws SignumException {
        ...
        when(accountServiceMock.getAssets(eq(mockAccountId), eq(0), eq(-1)))
                .thenReturn(new CollectionWithIndex<Account.AccountAsset>(mockAssetOverview, -1));
        ...
        assertEquals("" + mockUnconfirmedQuantityNQT,
