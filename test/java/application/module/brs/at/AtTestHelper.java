...
public class AtTestHelper {
    ...
    static byte[] ECHO_CREATION_BYTES = getCreationBytes((short) 2, 1, Convert.parseHexString(
    ...
    static byte[] TIP_THANKS_CREATION_BYTES = getCreationBytes((short) 2, 2, Convert.parseHexString(
    ...
    // Hello World example compiled with BlockTalk v0.0.0
    static byte[] HELLO_WORLD_CREATION_BYTES_V3 = getCreationBytes((short) 3, 1, Convert.parseHexString(
            ""));

    // Echo example compiled with BlockTalk v0.0.0
    static byte[] ECHO_CREATION_BYTES_V3 = getCreationBytes((short) 3, 1, Convert.parseHexString(
            ""));

    // Tip Thanks example compiled with BlockTalk v0.0.0
    static byte[] TIP_THANKS_CREATION_BYTES_V3 = getCreationBytes((short) 3, 2, Convert.parseHexString(
            ""));
