...
import application.module.brs.fluxcapacitor.FluxEnable;
...
class BlockServiceImplTest extends AbstractUnitTest {
    ...
    private static BlockServiceImpl buildSubject() {
        ...
        when(accountService.getOrAddAccount(anyLong()))
                .thenAnswer(inv -> ((long) inv.getArgument(0)) == 0L ? nullAccount : generatorAccount);
