...
import static application.module.brs.common.TestConstants.TEST_PUBLIC_KEY_BYTES;
...
public class DecryptFromTest {
    ...
    public void processRequest() throws SignumException {
        ...
        assertEquals("\u0001",
                JSON.getAsString(JSON.getAsJsonObject(t.processRequest(req)).get(DECRYPTED_MESSAGE_RESPONSE)));
    }
