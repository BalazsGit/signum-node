...
import application.module.brs.Attachment.MessagingAliasSell;
import application.module.brs.SignumException.NotCurrentlyValidException;
import application.module.brs.SignumException.ValidationException;
import application.module.brs.Transaction.Builder;
...
import static application.module.brs.Attachment.ORDINARY_PAYMENT;
