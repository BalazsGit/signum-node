...
public class MockGeneratorTest {
    ...
    public void testGeneratorCalculateHit() {
        assertEquals(BigInteger.valueOf(1000L), generator.calculateHit(TestConstants.TEST_ACCOUNT_NUMERIC_ID_PARSED, 0,
        ...
        assertEquals(BigInteger.valueOf(1000L), generator.calculateHit(exampleGenSig, Convert.parseHexString(
