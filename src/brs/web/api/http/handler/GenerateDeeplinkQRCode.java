...
public class GenerateDeeplinkQRCode extends HttpRequestHandler {
  ...
  public GenerateDeeplinkQRCode(DeeplinkQRCodeGenerator deeplinkQRCodeGenerator) {
    super(new LegacyDocTag[]{LegacyDocTag.CREATE_TRANSACTION, LegacyDocTag.TRANSACTIONS}, IMMUTABLE_PARAMETER, RECEIVER_ID_PARAMETER, AMOUNT_NQT_PARAMETER, FEE_NQT_PARAMETER, FEE_SUGGESTION_TYPE_PARAMETER, MESSAGE_PARAMETER);
