...
import static brs.web.api.http.common.Parameters.ASSET_IDS_AND_QUANTITIES_PARAMETER;
...
public final class TransferAssetMulti extends CreateTransaction {
  ...
  public TransferAssetMulti(ParameterService parameterService, Blockchain blockchain, APITransactionManager apiTransactionManager, AccountService accountService) {
    super(new LegacyDocTag[] {LegacyDocTag.AE, LegacyDocTag.CREATE_TRANSACTION}, apiTransactionManager, RECIPIENT_PARAMETER, ASSET_IDS_AND_QUANTITIES_PARAMETER, AMOUNT_NQT_PARAMETER);
