...
public abstract class AtController {
    ...
    private static long makeTransactions(AT at, int blockHeight, long generatorId) throws AtException {
         ...
         * ASSET_MINT transactions come before ASSET_TRANSFER transactions for the same
         * asset.
         * If two transactions are of different types (one is mint and the other is
         * transfer),
         ...
         * attempts to transfer tokens that have not yet been minted within the same
         * block.
