...
public class SignumGUI extends JFrame {
    ...
    private JCheckBox showBlocksPerSecondCheckbox;
    private JCheckBox showTransactionsPerSecondCheckbox;
    private JCheckBox showTransactionsPerBlockCheckbox;
    private XYSeries dbTimePerBlockSeries;
    private XYSeries calculationTimePerBlockSeries;
    private JCheckBox showPushTimeCheckbox;
    private JCheckBox showDbTimeCheckbox;
    private JCheckBox showCalculationTimeCheckbox;
    private JCheckBox showUploadSpeedCheckbox;
    private JCheckBox showDownloadSpeedCheckbox;
    ...
    private JLabel uploadSpeedValueLabel;
    private JLabel uploadSpeedDimensionLabel;
    ...
    private JCheckBox showUploadVolumeCheckbox;
    private JCheckBox showDownloadVolumeCheckbox;
     ...
     * new SignumGUI("Signum Node", Props.ICON_LOCATION.getDefaultValue(),
    ...
    public SignumGUI(String programName, String iconLocation, String version, Signum signum) {
        ...
        showBlocksPerSecondCheckbox = new JCheckBox();
        showBlocksPerSecondCheckbox.setSelected(true);
        showBlocksPerSecondCheckbox.addActionListener(e -> {
            performanceChartPanel.getChart().getXYPlot().getRenderer(0).setSeriesVisible(0,
                    showBlocksPerSecondCheckbox.isSelected());
        });
        gbc.gridx = 2;
        gbc.gridy = 3;
        gbc.anchor = GridBagConstraints.LINE_START;
        downloadPanel.add(showBlocksPerSecondCheckbox, gbc);
        ...
        showTransactionsPerSecondCheckbox = new JCheckBox();
        showTransactionsPerSecondCheckbox.setSelected(true);
        showTransactionsPerSecondCheckbox.addActionListener(e -> {
            performanceChartPanel.getChart().getXYPlot().getRenderer(0).setSeriesVisible(1,
                    showTransactionsPerSecondCheckbox.isSelected());
        });
        gbc.gridx = 2;
        gbc.gridy = 4;
        gbc.anchor = GridBagConstraints.LINE_START;
        downloadPanel.add(showTransactionsPerSecondCheckbox, gbc);
        ...
        showTransactionsPerBlockCheckbox = new JCheckBox();
        showTransactionsPerBlockCheckbox.setSelected(true);
        showTransactionsPerBlockCheckbox.addActionListener(e -> {
            boolean isSelected = showTransactionsPerBlockCheckbox.isSelected();
            performanceChartPanel.getChart().getXYPlot().getRenderer(1).setSeriesVisible(0, isSelected);
            timingChartPanel.getChart().getXYPlot().getRenderer(1).setSeriesVisible(0, isSelected);
        });
        gbc.gridx = 2;
        gbc.gridy = 5;
        gbc.anchor = GridBagConstraints.LINE_START;
        downloadPanel.add(showTransactionsPerBlockCheckbox, gbc);
        ...
        showPushTimeCheckbox = new JCheckBox();
        showPushTimeCheckbox.setSelected(true);
        showPushTimeCheckbox.addActionListener(e -> {
            timingChartPanel.getChart().getXYPlot().getRenderer(0).setSeriesVisible(0,
                    showPushTimeCheckbox.isSelected());
        });
        timingGbc.gridx = 2;
        timingGbc.gridy = 0;
        timingInfoPanel.add(showPushTimeCheckbox, timingGbc);
        ...
        showDbTimeCheckbox = new JCheckBox();
        showDbTimeCheckbox.setSelected(true);
        showDbTimeCheckbox.addActionListener(e -> {
            timingChartPanel.getChart().getXYPlot().getRenderer(0).setSeriesVisible(1,
                    showDbTimeCheckbox.isSelected());
        });
        timingGbc.gridx = 2;
        timingGbc.gridy = 1;
        timingInfoPanel.add(showDbTimeCheckbox, timingGbc);
        ...
        showCalculationTimeCheckbox = new JCheckBox();
        showCalculationTimeCheckbox.setSelected(true);
        showCalculationTimeCheckbox.addActionListener(e -> {
            timingChartPanel.getChart().getXYPlot().getRenderer(0).setSeriesVisible(2,
                    showCalculationTimeCheckbox.isSelected());
        });
        timingGbc.gridx = 2;
        timingGbc.gridy = 2;
        timingInfoPanel.add(showCalculationTimeCheckbox, timingGbc);
        ...
        showUploadSpeedCheckbox = new JCheckBox();
        showUploadSpeedCheckbox.setSelected(true);
        showUploadSpeedCheckbox.addActionListener(e -> {
            netSpeedChartPanel.getChart().getXYPlot().getRenderer(0).setSeriesVisible(0,
                    showUploadSpeedCheckbox.isSelected());
        });
        timingGbc.gridx = 2;
        timingGbc.gridy = 4;
        timingInfoPanel.add(showUploadSpeedCheckbox, timingGbc);
        ...
        showDownloadSpeedCheckbox = new JCheckBox();
        showDownloadSpeedCheckbox.setSelected(true);
        showDownloadSpeedCheckbox.addActionListener(e -> {
            netSpeedChartPanel.getChart().getXYPlot().getRenderer(0).setSeriesVisible(1,
                    showDownloadSpeedCheckbox.isSelected());
        });
        timingGbc.gridx = 2;
        timingGbc.gridy = 5;
        timingInfoPanel.add(showDownloadSpeedCheckbox, timingGbc);

        // --- Upload Volume ---
        JLabel uploadVolumeTitleLabel = new JLabel("Uploaded Volume:", SwingConstants.RIGHT);
        uploadVolumeTitleLabel.setForeground(new Color(233, 150, 122));
        timingGbc.gridx = 0;
        timingGbc.gridy = 6;
        timingInfoPanel.add(uploadVolumeTitleLabel, timingGbc);

        metricsUploadVolumeLabel = new JLabel("0 B", SwingConstants.CENTER);
        timingGbc.gridx = 1;
        timingGbc.gridy = 6;
        timingGbc.fill = GridBagConstraints.HORIZONTAL;
        timingInfoPanel.add(metricsUploadVolumeLabel, timingGbc);
        timingGbc.fill = GridBagConstraints.NONE; // Reset fill

        showUploadVolumeCheckbox = new JCheckBox();
        showUploadVolumeCheckbox.setSelected(true); // Default to visible
        showUploadVolumeCheckbox.addActionListener(e -> {
            netSpeedChartPanel.getChart().getXYPlot().getRenderer(1).setSeriesVisible(0,
                    showUploadVolumeCheckbox.isSelected());
        });
        timingGbc.gridx = 2;
        timingGbc.gridy = 6;
        timingInfoPanel.add(showUploadVolumeCheckbox, timingGbc);

        // --- Download Volume ---
        JLabel downloadVolumeTitleLabel = new JLabel("Downloaded Volume:", SwingConstants.RIGHT);
        downloadVolumeTitleLabel.setForeground(new Color(50, 205, 50));
        timingGbc.gridx = 0;
        timingGbc.gridy = 7;
        timingInfoPanel.add(downloadVolumeTitleLabel, timingGbc);

        metricsDownloadVolumeLabel = new JLabel("0 B", SwingConstants.CENTER);
        timingGbc.gridx = 1;
        timingGbc.gridy = 7;
        timingGbc.fill = GridBagConstraints.HORIZONTAL;
        timingInfoPanel.add(metricsDownloadVolumeLabel, timingGbc);
        timingGbc.fill = GridBagConstraints.NONE; // Reset fill

        showDownloadVolumeCheckbox = new JCheckBox();
        showDownloadVolumeCheckbox.setSelected(true); // Default to visible
        showDownloadVolumeCheckbox.addActionListener(e -> {
            netSpeedChartPanel.getChart().getXYPlot().getRenderer(1).setSeriesVisible(1,
                    showDownloadVolumeCheckbox.isSelected());
        });
        timingGbc.gridx = 2;
        timingGbc.gridy = 7;
        timingInfoPanel.add(showDownloadVolumeCheckbox, timingGbc);
        ...
        // Upload
        // uploadSpeedLabel = new JLabel("↑ 000 MB/s");
        uploadSpeedValueLabel = new JLabel("▲ 000");
        uploadSpeedDimensionLabel = new JLabel("MB/s");

        /*
         * uploadSpeedLabel.setFont(monoFont);
         * 
         * Dimension speedDim = new Dimension(
         * uploadSpeedLabel.getFontMetrics(monoFont).stringWidth("↑ 000 MB/s"),
         * uploadSpeedLabel.getPreferredSize().height);
         * // uploadSpeedLabel.setPreferredSize(speedDim);
         */

        // speedPanel.add(uploadSpeedLabel);
        // speedPanel.add(uploadSpeedValueLabel, BorderLayout.CENTER);
        // speedPanel.add(uploadSpeedDimensionLabel, BorderLayout.PAGE_END);

        // Download
        downloadSpeedValueLabel = new JLabel("▼ 000");
        downloadSpeedDimensionLabel = new JLabel("MB/s");
        // downloadSpeedLabel = new JLabel("↓ 000 MB/s");
        // downloadSpeedLabel.setFont(monoFont);
        // downloadSpeedLabel.setPreferredSize(speedDim);
        // speedPanel.add(downloadSpeedLabel);
        speedPanel.add(downloadSpeedValueLabel, BorderLayout.CENTER);

        speedPanel.add(downloadSpeedDimensionLabel, BorderLayout.EAST);
    ...
    private void initListeners() {
        ...
        /*
         * Signum.getBlockchainProcessor().addProcessorListener(newProcessor -> {
         * SwingUtilities.invokeLater(() -> updateProcessor(newProcessor));
         * });
         */
        Signum.getBlockchainProcessor().addPerformanceListener((totalTimeMs, dbTimeMs, txCount, blockHeight) -> {
            SwingUtilities.invokeLater(() -> updateTimingChart(totalTimeMs, dbTimeMs, txCount, blockHeight));
        });
    ...
    private void updateProcessor(String newProcessor) {
        processorLabel.setText(newProcessor);
    }
    ...
    private void updateTimingChart(long totalTimeMs, long dbTimeMs, int txCount, int blockHeight) {
        ...
        long calculationTimeMs = displayPushTime - displayDbTime;
