...
public interface NetworkParameters {
    ...
    /**
     * This method can either add or remove transaction types/subtyes on the given
     * map.
     */
    ...
    /**
     * @param height
     * @return the block reward distribution in per thousand for the given account
     *         IDs
     */
    ...
    /**
     * A new unconfirmed transaction was removed from the mempool (either expired or
     * confirmed)
     *
     * @param transaction
     */
