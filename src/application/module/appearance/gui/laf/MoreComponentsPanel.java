...
class MoreComponentsPanel
    ...
    private void initComponents() {
        ...
        // ======== panel3 ========
        {
            ...
            // ---- label3 ----
            label3.setText(
                    "<html>JLabel HTML<br>Sample <b>content</b><br> <u>text</u> with <a href=\"#\">link</a></html>");
            ...
            // ======== scrollPane15 ========
            {
                ...
                editorPane6.setText(
                        "JEditorPane HTML<br>Sample <b>content</b><br> <u>text</u> with <a href=\"#\">link</a>");
            ...
            // ======== scrollPane16 ========
            {
                ...
                textPane6
                        .setText("JTextPane HTML<br>Sample <b>content</b><br> <u>text</u> with <a href=\"#\">link</a>");
        ...
        // ======== toolBar1 ========
        {
            ...
            java.net.URL imgUrl = getClass().getClassLoader()
                    .getResource(GuiResources.FLATLAF_ICONS_PATH + "intellij-showWriteAccess.png");
            if (imgUrl != null) {
                button1.setIcon(new ImageIcon(imgUrl));
            }
        ...
        // ======== panel4 ========
        {
            panel4.putClientProperty(FlatClientProperties.STYLE,
                    "border: 1,1,1,1,@disabledForeground,1,16; background: darken($Panel.background,5%)");
