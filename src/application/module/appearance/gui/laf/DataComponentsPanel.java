...
class DataComponentsPanel
    ...
    private void treeWideSelectionChanged() {
        UIManager.put("Tree.wideSelection", treeWideSelectionCheckBox.isSelected());
        FlatLaf.updateUI();
    }
    ...
    private void roundedSelectionChanged() {
        ...
        if (roundedSelectionCheckBox.isSelected()) {
            arc = 6;
            if (rowSelectionCheckBox.isSelected())
                insets = new Insets(0, 1, 0, 1);
        }
        UIManager.put("Table.selectionArc", arc);
        UIManager.put("Table.selectionInsets", insets);
        FlatLaf.updateUI();
    }
    ...
    private void initComponents() {
        ...
        ((JComboBox) ((DefaultCellEditor) table1.getColumnModel().getColumn(3).getCellEditor()).getComponent())
                .setEditable(true);
    }
