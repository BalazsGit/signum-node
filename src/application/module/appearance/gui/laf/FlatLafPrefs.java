...
public class FlatLafPrefs {
    ...
    public static final String PREFS_ROOT_PATH = "/flatlaf-settings";
     ...
     */
    public static void registerSystemScaleFactors(JComponent component) {
        registerSystemScaleFactor(component, "alt shift F1", null);
        registerSystemScaleFactor(component, "alt shift F2", "1");

        if (SystemInfo.isWindows) {
            registerSystemScaleFactor(component, "alt shift F3", "1.25");
            registerSystemScaleFactor(component, "alt shift F4", "1.5");
            registerSystemScaleFactor(component, "alt shift F5", "1.75");
            registerSystemScaleFactor(component, "alt shift F6", "2");
            registerSystemScaleFactor(component, "alt shift F7", "2.25");
            registerSystemScaleFactor(component, "alt shift F8", "2.5");
            registerSystemScaleFactor(component, "alt shift F9", "2.75");
            registerSystemScaleFactor(component, "alt shift F10", "3");
            registerSystemScaleFactor(component, "alt shift F11", "3.5");
            registerSystemScaleFactor(component, "alt shift F12", "4");
        } else {
            // Java on macOS and Linux supports only integer scale factors
            registerSystemScaleFactor(component, "alt shift F3", "2");
            registerSystemScaleFactor(component, "alt shift F4", "3");
            registerSystemScaleFactor(component, "alt shift F5", "4");

        }
    }

    private static void registerSystemScaleFactor(JComponent component, String keyStrokeStr, String scaleFactor) {
        ...
        component.registerKeyboardAction(
                e -> applySystemScaleFactor(component, scaleFactor),
                keyStroke,
                JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT);
    }

    private static void applySystemScaleFactor(Component parent, String scaleFactor) {
        Window window = SwingUtilities.windowForComponent(parent);
        String title = (window instanceof Frame) ? ((Frame) window).getTitle()
                : (window instanceof Dialog) ? ((Dialog) window).getTitle() : null;
    ...
    public static void initLafSync(JComponent component) {
        component.registerKeyboardAction(
