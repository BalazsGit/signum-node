...
package application.module.appearance.gui.laf;
...
class TabsPanel
    ...
    private void borderChanged() {
        ...
        UIManager.put("TabbedPane.hasFullBorder", hasFullBorder);
        FlatLaf.updateUI();
    }
    ...
    private void customComponentsChanged() {
        ...
        if (leadingComponentButton.isSelected()) {
            ...
            leading.add(new JButton(
                    new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "project.svg", getClass().getClassLoader())));
        }
        if (trailingComponentButton.isSelected()) {
            ...
            trailing.add(
                    new JButton(new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "buildLoadChanges.svg",
                            getClass().getClassLoader())));
            trailing.add(Box.createHorizontalGlue());
            trailing.add(new JButton(
                    new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "commit.svg", getClass().getClassLoader())));
            trailing.add(new JButton(
                    new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "diff.svg", getClass().getClassLoader())));
            trailing.add(new JButton(
                    new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "listFiles.svg", getClass().getClassLoader())));
        }
    ...
    private void initTabIconPlacement(JTabbedPane tabbedPane, int iconPlacement) {
        ...
        tabbedPane.addTab("Search", new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "search.svg", iconSize, iconSize,
                getClass().getClassLoader()),
                null);
        tabbedPane.addTab("Recents",
                new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "RecentlyUsed.svg", iconSize, iconSize,
                        getClass().getClassLoader()),
                null);
        if (topOrBottom)
            tabbedPane.addTab("Favorites", new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "favorite.svg", iconSize,
                    iconSize, getClass().getClassLoader()),
                    null);
    }
    ...
    private void initTabAlignment(JTabbedPane tabbedPane, int tabAlignment) {
        boolean vertical = (tabbedPane.getTabPlacement() == JTabbedPane.LEFT
                || tabbedPane.getTabPlacement() == JTabbedPane.RIGHT);
    ...
    private void initTabWidthMode(JTabbedPane tabbedPane, String tabWidthMode) {
        ...
        if (tabWidthMode.equals(TABBED_PANE_TAB_WIDTH_MODE_COMPACT) ||
            ...
            tabbedPane.addTab("Search", new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "search.svg", 16, 16,
                    getClass().getClassLoader()), null);
            tabbedPane.addTab("Recents", new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "RecentlyUsed.svg", 16, 16,
                    getClass().getClassLoader()),
                    null);
            tabbedPane.addTab("Favorites", new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "favorite.svg", 16, 16,
                    getClass().getClassLoader()),
                    null);
        } else {
    ...
    private void putTabbedPanesClientProperty(String key, Object value) {
        String uiKey = key;
        if (key.startsWith("JTabbedPane.")) {
            uiKey = "TabbedPane." + key.substring("JTabbedPane.".length());
        }
        UIManager.put(uiKey, value);
        FlatLaf.updateUI();
    }
        ...
        // ======== panel6 ========
        {
            ...
            // ======== panel3 ========
            {
                ...
                // ======== panel5 ========
                {
                    ...
                    {
                        tabAlignLeadingTabbedPane.putClientProperty(FlatClientProperties.TABBED_PANE_TAB_HEIGHT,
                                28);
                    }
                    ...
                    // ======== tabAlignVerticalTabbedPane ========
                    {
                        ...
                        tabAlignVerticalTabbedPane.putClientProperty(FlatClientProperties.TABBED_PANE_TAB_HEIGHT,
                                28);
                    }
                    ...
                    {
                        tabAlignTrailingTabbedPane.putClientProperty(FlatClientProperties.TABBED_PANE_TAB_HEIGHT,
                                28);
                    }
