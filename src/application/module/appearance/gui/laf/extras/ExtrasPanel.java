...
package application.module.appearance.gui.laf.extras;
...
public class ExtrasPanel
    ...
    private void initRainbowIcon() {
        FlatSVGIcon icon = new FlatSVGIcon(GuiResources.FLATLAF_RESOURCE_PATH + "extras/svg/informationDialog.svg",
    ...
    private void addSVGIcon(String name) {
        svgIconsPanel.add(new JLabel(new FlatSVGIcon(GuiResources.FLATLAF_RESOURCE_PATH + "extras/svg/" + name,
                getClass().getClassLoader())));
    }
