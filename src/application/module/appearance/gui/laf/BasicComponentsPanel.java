...
class BasicComponentsPanel
    ...
    BasicComponentsPanel() {
        ...
        trailingIconTextField.putClientProperty(FlatClientProperties.TEXT_FIELD_TRAILING_ICON,
                new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "DataTables.svg", getClass().getClassLoader()));
        iconsTextField.putClientProperty(FlatClientProperties.TEXT_FIELD_LEADING_ICON,
                new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "user.svg", getClass().getClassLoader()));
        iconsTextField.putClientProperty(FlatClientProperties.TEXT_FIELD_TRAILING_ICON,
                new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "bookmarkGroup.svg", getClass().getClassLoader()));
        ...
        JToggleButton matchCaseButton = new JToggleButton(
                new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "matchCase.svg", getClass().getClassLoader()));
        matchCaseButton
                .setRolloverIcon(new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "matchCaseHovered.svg",
                        getClass().getClassLoader()));
        matchCaseButton.setSelectedIcon(
                new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "matchCaseSelected.svg",
                        getClass().getClassLoader()));
        matchCaseButton.setToolTipText("Match Case");

        // whole words button
        JToggleButton wordsButton = new JToggleButton(
                new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "words.svg", getClass().getClassLoader()));
        wordsButton.setRolloverIcon(
                new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "wordsHovered.svg", getClass().getClassLoader()));
        wordsButton.setSelectedIcon(
                new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "wordsSelected.svg", getClass().getClassLoader()));
        wordsButton.setToolTipText("Whole Words");

        // regex button
        JToggleButton regexButton = new JToggleButton(
                new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "regex.svg", getClass().getClassLoader()));
        regexButton.setRolloverIcon(
                new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "regexHovered.svg", getClass().getClassLoader()));
        regexButton.setSelectedIcon(
                new FlatSVGIcon(GuiResources.FLATLAF_ICONS_PATH + "regexSelected.svg", getClass().getClassLoader()));
    ...
    private void initComponents() {
        ...
        if (FlatLafCommon.screenshotsMode) {
            ...
            Component[] hiddenComponents = {
                    ...
                    formattedTextFieldLabel, formattedTextField1, formattedTextField2, formattedTextField3,
                    formattedTextField4, formattedTextField5,
