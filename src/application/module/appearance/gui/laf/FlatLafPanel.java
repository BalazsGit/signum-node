...
import application.module.appearance.gui.laf.HintManager.Hint;
import application.module.appearance.gui.laf.extras.ExtrasPanel;
import application.module.appearance.gui.laf.intellijthemes.IJThemesPanel;
...
public class FlatLafPanel
    ...
    public void updateUI() {
        super.updateUI();
        customFont = AppearanceModule.getActiveCustomFont();
        customConsoleFont = AppearanceModule.getActiveConsoleFont();
    ...
    private void populateFontMenu(JMenu menu, boolean isConsole) {
        ...
        Font currentFont = isConsole ? AppearanceModule.getActiveConsoleFont() : UIManager.getFont("Label.font");
