...
public class LoggerProfile {
    ...
    public void applyInternalDefaults() {
        ...
        properties.setProperty("node.level", "INFO");
        properties.setProperty("java.util.logging.ConsoleHandler.level", "ALL");
        properties.setProperty("java.util.logging.ConsoleHandler.formatter", "node.util.BriefLogFormatter");
        ...
        properties.setProperty("node.db.store.DerivedTableManager.level", "OFF");
        properties.setProperty("org.jooq.Constants.level", "OFF");
        properties.setProperty("node.gui.consoleLogSize", "100000");
    }
