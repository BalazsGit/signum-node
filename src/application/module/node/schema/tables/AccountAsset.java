...
public class AccountAsset extends TableImpl<AccountAssetRecord> {
     ...
     */
    public final TableField<AccountAssetRecord, Long> DB_ID = createField(DSL.name("db_id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.account_asset.account_id</code>.
     */
    public final TableField<AccountAssetRecord, Long> ACCOUNT_ID = createField(DSL.name("account_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.account_asset.asset_id</code>.
     */
    public final TableField<AccountAssetRecord, Long> ASSET_ID = createField(DSL.name("asset_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.account_asset.quantity</code>.
     */
    public final TableField<AccountAssetRecord, Long> QUANTITY = createField(DSL.name("quantity"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.account_asset.unconfirmed_quantity</code>.
     */
    public final TableField<AccountAssetRecord, Long> UNCONFIRMED_QUANTITY = createField(
            DSL.name("unconfirmed_quantity"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.account_asset.height</code>.
     */
    public final TableField<AccountAssetRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.account_asset.latest</code>.
     */
    public final TableField<AccountAssetRecord, Boolean> LATEST = createField(DSL.name("latest"),
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.ACCOUNT_ASSET_ACCOUNT_ASSET_HEIGHT_IDX,
