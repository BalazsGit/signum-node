...
public class Escrow extends TableImpl<EscrowRecord> {
     ...
     */
    public final TableField<EscrowRecord, Long> DB_ID = createField(DSL.name("db_id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.escrow.id</code>.
     */
    public final TableField<EscrowRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false),
            this, "");

    /**
     * The column <code>DB.escrow.sender_id</code>.
     */
    public final TableField<EscrowRecord, Long> SENDER_ID = createField(DSL.name("sender_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.escrow.recipient_id</code>.
     */
    public final TableField<EscrowRecord, Long> RECIPIENT_ID = createField(DSL.name("recipient_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.escrow.amount</code>.
     */
    public final TableField<EscrowRecord, Long> AMOUNT = createField(DSL.name("amount"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.escrow.required_signers</code>.
     */
    public final TableField<EscrowRecord, Integer> REQUIRED_SIGNERS = createField(DSL.name("required_signers"),
            SQLDataType.INTEGER.defaultValue(DSL.field("NULL", SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>DB.escrow.deadline</code>.
     */
    public final TableField<EscrowRecord, Integer> DEADLINE = createField(DSL.name("deadline"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.escrow.deadline_action</code>.
     */
    public final TableField<EscrowRecord, Integer> DEADLINE_ACTION = createField(DSL.name("deadline_action"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.escrow.height</code>.
     */
    public final TableField<EscrowRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.escrow.latest</code>.
     */
    public final TableField<EscrowRecord, Boolean> LATEST = createField(DSL.name("latest"),
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.ESCROW_ESCROW_DEADLINE_HEIGHT_IDX, Indexes.ESCROW_ESCROW_RECIPIENT_ID_HEIGHT_IDX,
