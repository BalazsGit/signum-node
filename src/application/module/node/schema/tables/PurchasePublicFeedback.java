...
public class PurchasePublicFeedback extends TableImpl<PurchasePublicFeedbackRecord> {
     ...
     */
    public final TableField<PurchasePublicFeedbackRecord, Long> DB_ID = createField(DSL.name("db_id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.purchase_public_feedback.id</code>.
     */
    public final TableField<PurchasePublicFeedbackRecord, Long> ID = createField(DSL.name("id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.purchase_public_feedback.public_feedback</code>.
     */
    public final TableField<PurchasePublicFeedbackRecord, String> PUBLIC_FEEDBACK = createField(
            DSL.name("public_feedback"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>DB.purchase_public_feedback.height</code>.
     */
    public final TableField<PurchasePublicFeedbackRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.purchase_public_feedback.latest</code>.
     */
    public final TableField<PurchasePublicFeedbackRecord, Boolean> LATEST = createField(DSL.name("latest"),
