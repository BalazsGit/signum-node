...
public class AtState extends TableImpl<AtStateRecord> {
     ...
     */
    public final TableField<AtStateRecord, Long> DB_ID = createField(DSL.name("db_id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.at_state.at_id</code>.
     */
    public final TableField<AtStateRecord, Long> AT_ID = createField(DSL.name("at_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.state</code>.
     */
    public final TableField<AtStateRecord, byte[]> STATE = createField(DSL.name("state"),
            SQLDataType.BLOB.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.prev_height</code>.
     */
    public final TableField<AtStateRecord, Integer> PREV_HEIGHT = createField(DSL.name("prev_height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.next_height</code>.
     */
    public final TableField<AtStateRecord, Integer> NEXT_HEIGHT = createField(DSL.name("next_height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.sleep_between</code>.
     */
    public final TableField<AtStateRecord, Integer> SLEEP_BETWEEN = createField(DSL.name("sleep_between"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.prev_balance</code>.
     */
    public final TableField<AtStateRecord, Long> PREV_BALANCE = createField(DSL.name("prev_balance"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.freeze_when_same_balance</code>.
     */
    public final TableField<AtStateRecord, Boolean> FREEZE_WHEN_SAME_BALANCE = createField(
            DSL.name("freeze_when_same_balance"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.min_activate_amount</code>.
     */
    public final TableField<AtStateRecord, Long> MIN_ACTIVATE_AMOUNT = createField(DSL.name("min_activate_amount"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.height</code>.
     */
    public final TableField<AtStateRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.latest</code>.
     */
    public final TableField<AtStateRecord, Boolean> LATEST = createField(DSL.name("latest"),
