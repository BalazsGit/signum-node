...
public class PurchaseFeedback extends TableImpl<PurchaseFeedbackRecord> {
     ...
     */
    public final TableField<PurchaseFeedbackRecord, Long> DB_ID = createField(DSL.name("db_id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.purchase_feedback.id</code>.
     */
    public final TableField<PurchaseFeedbackRecord, Long> ID = createField(DSL.name("id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.purchase_feedback.feedback_data</code>.
     */
    public final TableField<PurchaseFeedbackRecord, byte[]> FEEDBACK_DATA = createField(DSL.name("feedback_data"),
            SQLDataType.BLOB.nullable(false), this, "");

    /**
     * The column <code>DB.purchase_feedback.feedback_nonce</code>.
     */
    public final TableField<PurchaseFeedbackRecord, byte[]> FEEDBACK_NONCE = createField(DSL.name("feedback_nonce"),
            SQLDataType.VARBINARY(32).nullable(false), this, "");

    /**
     * The column <code>DB.purchase_feedback.height</code>.
     */
    public final TableField<PurchaseFeedbackRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.purchase_feedback.latest</code>.
     */
    public final TableField<PurchaseFeedbackRecord, Boolean> LATEST = createField(DSL.name("latest"),
