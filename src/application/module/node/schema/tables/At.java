...
public class At extends TableImpl<AtRecord> {
     ...
     */
    public final TableField<AtRecord, Long> DB_ID = createField(DSL.name("db_id"),
     ...
     */
    public final TableField<AtRecord, Long> CREATOR_ID = createField(DSL.name("creator_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.at.name</code>.
     */
    public final TableField<AtRecord, String> NAME = createField(DSL.name("name"),
            SQLDataType.VARCHAR(30).defaultValue(DSL.field("NULL", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>DB.at.description</code>.
     */
    public final TableField<AtRecord, String> DESCRIPTION = createField(DSL.name("description"),
            SQLDataType.CLOB.defaultValue(DSL.field("NULL", SQLDataType.CLOB)), this, "");

    /**
     * The column <code>DB.at.version</code>.
     */
    public final TableField<AtRecord, Short> VERSION = createField(DSL.name("version"),
            SQLDataType.SMALLINT.nullable(false), this, "");

    /**
     * The column <code>DB.at.csize</code>.
     */
    public final TableField<AtRecord, Integer> CSIZE = createField(DSL.name("csize"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.at.dsize</code>.
     */
    public final TableField<AtRecord, Integer> DSIZE = createField(DSL.name("dsize"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.at.c_user_stack_bytes</code>.
     */
    public final TableField<AtRecord, Integer> C_USER_STACK_BYTES = createField(DSL.name("c_user_stack_bytes"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.at.c_call_stack_bytes</code>.
     */
    public final TableField<AtRecord, Integer> C_CALL_STACK_BYTES = createField(DSL.name("c_call_stack_bytes"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.at.creation_height</code>.
     */
    public final TableField<AtRecord, Integer> CREATION_HEIGHT = createField(DSL.name("creation_height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.at.ap_code</code>.
     */
    public final TableField<AtRecord, byte[]> AP_CODE = createField(DSL.name("ap_code"),
            SQLDataType.BLOB.defaultValue(DSL.field("NULL", SQLDataType.BLOB)), this, "");

    /**
     * The column <code>DB.at.height</code>.
     */
    public final TableField<AtRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.at.latest</code>.
     */
    public final TableField<AtRecord, Boolean> LATEST = createField(DSL.name("latest"),
     ...
     */
    public final TableField<AtRecord, Long> AP_CODE_HASH_ID = createField(DSL.name("ap_code_hash_id"),
