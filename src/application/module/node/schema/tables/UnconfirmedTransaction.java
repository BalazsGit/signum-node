...
public class UnconfirmedTransaction extends TableImpl<UnconfirmedTransactionRecord> {
     ...
     */
    public final TableField<UnconfirmedTransactionRecord, Long> DB_ID = createField(DSL.name("db_id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.unconfirmed_transaction.id</code>.
     */
    public final TableField<UnconfirmedTransactionRecord, Long> ID = createField(DSL.name("id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.unconfirmed_transaction.expiration</code>.
     */
    public final TableField<UnconfirmedTransactionRecord, Integer> EXPIRATION = createField(DSL.name("expiration"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.unconfirmed_transaction.transaction_height</code>.
     */
    public final TableField<UnconfirmedTransactionRecord, Integer> TRANSACTION_HEIGHT = createField(
            DSL.name("transaction_height"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.unconfirmed_transaction.fee_per_byte</code>.
     */
    public final TableField<UnconfirmedTransactionRecord, Long> FEE_PER_BYTE = createField(DSL.name("fee_per_byte"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.unconfirmed_transaction.timestamp</code>.
     */
    public final TableField<UnconfirmedTransactionRecord, Integer> TIMESTAMP = createField(DSL.name("timestamp"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.unconfirmed_transaction.transaction_bytes</code>.
     */
    public final TableField<UnconfirmedTransactionRecord, byte[]> TRANSACTION_BYTES = createField(
            DSL.name("transaction_bytes"), SQLDataType.BLOB.nullable(false), this, "");

    /**
     * The column <code>DB.unconfirmed_transaction.height</code>.
     */
    public final TableField<UnconfirmedTransactionRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");
