...
public class Goods extends TableImpl<GoodsRecord> {
     ...
     */
    public final TableField<GoodsRecord, Long> DB_ID = createField(DSL.name("db_id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.goods.id</code>.
     */
    public final TableField<GoodsRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false),
            this, "");

    /**
     * The column <code>DB.goods.seller_id</code>.
     */
    public final TableField<GoodsRecord, Long> SELLER_ID = createField(DSL.name("seller_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.goods.name</code>.
     */
    public final TableField<GoodsRecord, String> NAME = createField(DSL.name("name"),
            SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>DB.goods.description</code>.
     */
    public final TableField<GoodsRecord, String> DESCRIPTION = createField(DSL.name("description"),
            SQLDataType.CLOB.defaultValue(DSL.field("NULL", SQLDataType.CLOB)), this, "");

    /**
     * The column <code>DB.goods.tags</code>.
     */
    public final TableField<GoodsRecord, String> TAGS = createField(DSL.name("tags"),
            SQLDataType.VARCHAR(100).defaultValue(DSL.field("NULL", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>DB.goods.timestamp</code>.
     */
    public final TableField<GoodsRecord, Integer> TIMESTAMP = createField(DSL.name("timestamp"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.goods.quantity</code>.
     */
    public final TableField<GoodsRecord, Integer> QUANTITY = createField(DSL.name("quantity"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.goods.price</code>.
     */
    public final TableField<GoodsRecord, Long> PRICE = createField(DSL.name("price"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.goods.delisted</code>.
     */
    public final TableField<GoodsRecord, Boolean> DELISTED = createField(DSL.name("delisted"),
            SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>DB.goods.height</code>.
     */
    public final TableField<GoodsRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.goods.latest</code>.
     */
    public final TableField<GoodsRecord, Boolean> LATEST = createField(DSL.name("latest"),
