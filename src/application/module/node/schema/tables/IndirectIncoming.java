...
public class IndirectIncoming extends TableImpl<IndirectIncomingRecord> {
     ...
     */
    public final TableField<IndirectIncomingRecord, Long> DB_ID = createField(DSL.name("db_id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.indirect_incoming.account_id</code>.
     */
    public final TableField<IndirectIncomingRecord, Long> ACCOUNT_ID = createField(DSL.name("account_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.indirect_incoming.transaction_id</code>.
     */
    public final TableField<IndirectIncomingRecord, Long> TRANSACTION_ID = createField(DSL.name("transaction_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.indirect_incoming.height</code>.
     */
    public final TableField<IndirectIncomingRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.indirect_incoming.amount</code>.
     */
    public final TableField<IndirectIncomingRecord, Long> AMOUNT = createField(DSL.name("amount"),
            SQLDataType.BIGINT.defaultValue(DSL.field("0", SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>DB.indirect_incoming.quantity</code>.
     */
    public final TableField<IndirectIncomingRecord, Long> QUANTITY = createField(DSL.name("quantity"),
            SQLDataType.BIGINT.defaultValue(DSL.field("0", SQLDataType.BIGINT)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.INDIRECT_INCOMING_INDIRECT_INCOMING_HEIGHT_IDX,
                Indexes.INDIRECT_INCOMING_INDIRECT_INCOMING_ID_INDEX,
                Indexes.INDIRECT_INCOMING_INDIRECT_INCOMING_INDEX);
    }
