...
public class Trade extends TableImpl<TradeRecord> {
     ...
     */
    public final TableField<TradeRecord, Long> DB_ID = createField(DSL.name("db_id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.trade.asset_id</code>.
     */
    public final TableField<TradeRecord, Long> ASSET_ID = createField(DSL.name("asset_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.trade.block_id</code>.
     */
    public final TableField<TradeRecord, Long> BLOCK_ID = createField(DSL.name("block_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.trade.ask_order_id</code>.
     */
    public final TableField<TradeRecord, Long> ASK_ORDER_ID = createField(DSL.name("ask_order_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.trade.bid_order_id</code>.
     */
    public final TableField<TradeRecord, Long> BID_ORDER_ID = createField(DSL.name("bid_order_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.trade.ask_order_height</code>.
     */
    public final TableField<TradeRecord, Integer> ASK_ORDER_HEIGHT = createField(DSL.name("ask_order_height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.trade.bid_order_height</code>.
     */
    public final TableField<TradeRecord, Integer> BID_ORDER_HEIGHT = createField(DSL.name("bid_order_height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.trade.seller_id</code>.
     */
    public final TableField<TradeRecord, Long> SELLER_ID = createField(DSL.name("seller_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.trade.buyer_id</code>.
     */
    public final TableField<TradeRecord, Long> BUYER_ID = createField(DSL.name("buyer_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.trade.quantity</code>.
     */
    public final TableField<TradeRecord, Long> QUANTITY = createField(DSL.name("quantity"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.trade.price</code>.
     */
    public final TableField<TradeRecord, Long> PRICE = createField(DSL.name("price"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.trade.timestamp</code>.
     */
    public final TableField<TradeRecord, Integer> TIMESTAMP = createField(DSL.name("timestamp"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.trade.height</code>.
     */
    public final TableField<TradeRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.TRADE_TRADE_ASSET_ID_IDX, Indexes.TRADE_TRADE_BUYER_ID_IDX,
                Indexes.TRADE_TRADE_HEIGHT_IDX, Indexes.TRADE_TRADE_SELLER_ID_IDX);
    }
