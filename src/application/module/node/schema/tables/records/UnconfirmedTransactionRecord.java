...
public class UnconfirmedTransactionRecord extends UpdatableRecordImpl<UnconfirmedTransactionRecord>
    ...
    @Override
    public UnconfirmedTransactionRecord values(Long value1, Long value2, Integer value3, Integer value4, Long value5,
            Integer value6, byte[] value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UnconfirmedTransactionRecord(Long dbId, Long id, Integer expiration, Integer transactionHeight,
            Long feePerByte, Integer timestamp, byte[] transactionBytes, Integer height) {
        super(UnconfirmedTransaction.UNCONFIRMED_TRANSACTION);
