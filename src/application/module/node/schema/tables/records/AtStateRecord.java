...
public class AtStateRecord extends UpdatableRecordImpl<AtStateRecord>
        implements Record11<Long, Long, byte[], Integer, Integer, Integer, Long, Boolean, Long, Integer, Boolean> {
    ...
    @Override
    public AtStateRecord values(Long value1, Long value2, byte[] value3, Integer value4, Integer value5, Integer value6,
            Long value7, Boolean value8, Long value9, Integer value10, Boolean value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AtStateRecord(Long dbId, Long atId, byte[] state, Integer prevHeight, Integer nextHeight,
            Integer sleepBetween, Long prevBalance, Boolean freezeWhenSameBalance, Long minActivateAmount,
        ...
        setSleepBetween(sleepBetween);
        setPrevBalance(prevBalance);
        setFreezeWhenSameBalance(freezeWhenSameBalance);
        setMinActivateAmount(minActivateAmount);
        setHeight(height);
        setLatest(latest);
    }
}
