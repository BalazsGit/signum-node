...
public class AtRecord extends UpdatableRecordImpl<AtRecord> implements
        Record15<Long, Long, Long, String, String, Short, Integer, Integer, Integer, Integer, Integer, byte[], Integer, Boolean, Long> {
    ...
    @Override
    public AtRecord values(Long value1, Long value2, Long value3, String value4, String value5, Short value6,
            Integer value7, Integer value8, Integer value9, Integer value10, Integer value11, byte[] value12,
            Integer value13, Boolean value14, Long value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AtRecord(Long dbId, Long id, Long creatorId, String name, String description, Short version, Integer csize,
            Integer dsize, Integer cUserStackBytes, Integer cCallStackBytes, Integer creationHeight, byte[] apCode,
            Integer height, Boolean latest, Long apCodeHashId) {
        super(At.AT);
