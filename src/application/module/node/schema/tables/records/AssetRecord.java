...
public class AssetRecord extends UpdatableRecordImpl<AssetRecord>
        implements Record9<Long, Long, Long, String, String, Long, Byte, Integer, Boolean> {
    ...
    @Override
    public AssetRecord values(Long value1, Long value2, Long value3, String value4, String value5, Long value6,
            Byte value7, Integer value8, Boolean value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AssetRecord(Long dbId, Long id, Long accountId, String name, String description, Long quantity,
            Byte decimals, Integer height, Boolean mintable) {
        super(Asset.ASSET);
