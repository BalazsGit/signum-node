...
public class AccountRecord extends UpdatableRecordImpl<AccountRecord>
        implements Record9<Long, Long, Integer, byte[], Integer, String, String, Integer, Boolean> {
    ...
    @Override
    public AccountRecord values(Long value1, Long value2, Integer value3, byte[] value4, Integer value5, String value6,
            String value7, Integer value8, Boolean value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountRecord(Long dbId, Long id, Integer creationHeight, byte[] publicKey, Integer keyHeight, String name,
            String description, Integer height, Boolean latest) {
        super(Account.ACCOUNT);
