...
public class EscrowRecord extends UpdatableRecordImpl<EscrowRecord>
    ...
    @Override
    public EscrowRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, Integer value6,
     ...
     */
    public EscrowRecord(Long dbId, Long id, Long senderId, Long recipientId, Long amount, Integer requiredSigners,
            Integer deadline, Integer deadlineAction, Integer height, Boolean latest) {
        super(Escrow.ESCROW);
