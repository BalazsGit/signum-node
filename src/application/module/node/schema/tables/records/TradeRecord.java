...
public class TradeRecord extends UpdatableRecordImpl<TradeRecord>
        implements Record13<Long, Long, Long, Long, Long, Integer, Integer, Long, Long, Long, Long, Integer, Integer> {
    ...
    @Override
    public TradeRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, Integer value6,
            Integer value7, Long value8, Long value9, Long value10, Long value11, Integer value12, Integer value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TradeRecord(Long dbId, Long assetId, Long blockId, Long askOrderId, Long bidOrderId, Integer askOrderHeight,
            Integer bidOrderHeight, Long sellerId, Long buyerId, Long quantity, Long price, Integer timestamp,
            Integer height) {
        super(Trade.TRADE);
