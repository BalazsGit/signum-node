...
public class TransactionRecord extends UpdatableRecordImpl<TransactionRecord> {
     ...
     */
    public TransactionRecord(Long dbId, Long id, Short deadline, byte[] senderPublicKey, Long recipientId, Long amount,
            Long fee, Integer height, Long blockId, byte[] signature, Integer timestamp, Byte type, Byte subtype,
            Long senderId, Integer blockTimestamp, byte[] fullHash, byte[] referencedTransactionFullhash,
            byte[] attachmentBytes, Byte version, Boolean hasMessage, Boolean hasEncryptedMessage,
            Boolean hasPublicKeyAnnouncement, Integer ecBlockHeight, Long ecBlockId, Boolean hasEncrypttoselfMessage,
            Long cashBackId) {
        super(Transaction.TRANSACTION);
        ...
        setReferencedTransactionFullhash(referencedTransactionFullhash);
        setAttachmentBytes(attachmentBytes);
        setVersion(version);
        setHasMessage(hasMessage);
        setHasEncryptedMessage(hasEncryptedMessage);
        setHasPublicKeyAnnouncement(hasPublicKeyAnnouncement);
