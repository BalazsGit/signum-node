...
public class EscrowDecisionRecord extends UpdatableRecordImpl<EscrowDecisionRecord>
    ...
    @Override
    public EscrowDecisionRecord values(Long value1, Long value2, Long value3, Integer value4, Integer value5,
            Boolean value6) {
        value1(value1);
        value2(value2);
        value3(value3);
     ...
     */
    public EscrowDecisionRecord(Long dbId, Long escrowId, Long accountId, Integer decision, Integer height,
            Boolean latest) {
        super(EscrowDecision.ESCROW_DECISION);
