...
public class GoodsRecord extends UpdatableRecordImpl<GoodsRecord> implements
        Record12<Long, Long, Long, String, String, String, Integer, Integer, Long, Boolean, Integer, Boolean> {
    ...
    @Override
    public GoodsRecord values(Long value1, Long value2, Long value3, String value4, String value5, String value6,
            Integer value7, Integer value8, Long value9, Boolean value10, Integer value11, Boolean value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GoodsRecord(Long dbId, Long id, Long sellerId, String name, String description, String tags,
            Integer timestamp, Integer quantity, Long price, Boolean delisted, Integer height, Boolean latest) {
        super(Goods.GOODS);
