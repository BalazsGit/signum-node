...
public class IndirectIncomingRecord extends UpdatableRecordImpl<IndirectIncomingRecord>
        implements Record6<Long, Long, Long, Integer, Long, Long> {
    ...
    @Override
    public IndirectIncomingRecord values(Long value1, Long value2, Long value3, Integer value4, Long value5,
            Long value6) {
        value1(value1);
        value2(value2);
        value3(value3);
     ...
     */
    public IndirectIncomingRecord(Long dbId, Long accountId, Long transactionId, Integer height, Long amount,
            Long quantity) {
        super(IndirectIncoming.INDIRECT_INCOMING);
