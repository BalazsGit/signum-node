...
public class SubscriptionRecord extends UpdatableRecordImpl<SubscriptionRecord>
    ...
    @Override
    public SubscriptionRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, Integer value6,
     ...
     */
    public SubscriptionRecord(Long dbId, Long id, Long senderId, Long recipientId, Long amount, Integer frequency,
            Integer timeNext, Integer height, Boolean latest) {
        super(Subscription.SUBSCRIPTION);
