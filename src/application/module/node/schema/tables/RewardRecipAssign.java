...
public class RewardRecipAssign extends TableImpl<RewardRecipAssignRecord> {
     ...
     */
    public final TableField<RewardRecipAssignRecord, Long> DB_ID = createField(DSL.name("db_id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.reward_recip_assign.account_id</code>.
     */
    public final TableField<RewardRecipAssignRecord, Long> ACCOUNT_ID = createField(DSL.name("account_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.reward_recip_assign.prev_recip_id</code>.
     */
    public final TableField<RewardRecipAssignRecord, Long> PREV_RECIP_ID = createField(DSL.name("prev_recip_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.reward_recip_assign.recip_id</code>.
     */
    public final TableField<RewardRecipAssignRecord, Long> RECIP_ID = createField(DSL.name("recip_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.reward_recip_assign.from_height</code>.
     */
    public final TableField<RewardRecipAssignRecord, Integer> FROM_HEIGHT = createField(DSL.name("from_height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.reward_recip_assign.height</code>.
     */
    public final TableField<RewardRecipAssignRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.reward_recip_assign.latest</code>.
     */
    public final TableField<RewardRecipAssignRecord, Boolean> LATEST = createField(DSL.name("latest"),
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.REWARD_RECIP_ASSIGN_REWARD_RECIP_ASSIGN_HEIGHT_IDX,
