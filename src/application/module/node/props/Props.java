package application.module.node.props;
...
public class Props {
    ...
    public static final Prop<Integer> REWARD_RECIPIENT_ENABLE_BLOCK_HEIGHT = new Prop<>(
            "node.rewardRecipient.startBlock", -1);
    public static final Prop<Integer> DIGITAL_GOODS_STORE_BLOCK_HEIGHT = new Prop<>("node.digitalGoodsStore.startBlock",
            -1);
    public static final Prop<Integer> AUTOMATED_TRANSACTION_BLOCK_HEIGHT = new Prop<>(
            "node.automatedTransactions.startBlock", -1);
    public static final Prop<Integer> AT_FIX_BLOCK_2_BLOCK_HEIGHT = new Prop<>("node.atFixBlock2.startBlock", -1);
    public static final Prop<Integer> AT_FIX_BLOCK_3_BLOCK_HEIGHT = new Prop<>("node.atFixBlock3.startBlock", -1);
    public static final Prop<Integer> AT_FIX_BLOCK_4_BLOCK_HEIGHT = new Prop<>("node.atFixBlock4.startBlock", -1);
    public static final Prop<Integer> PRE_POC2_BLOCK_HEIGHT = new Prop<>("node.prePoc2.startBlock", -1);
    public static final Prop<Integer> POC2_BLOCK_HEIGHT = new Prop<>("node.poc2.startBlock", -1);
    public static final Prop<Integer> SODIUM_BLOCK_HEIGHT = new Prop<>("node.sodium.startBlock", -1);
    public static final Prop<Integer> SIGNUM_HEIGHT = new Prop<>("node.signum.startBlock", -1);
    public static final Prop<Integer> POC_PLUS_HEIGHT = new Prop<>("node.pocPlus.startBlock", -1);
    public static final Prop<Integer> SPEEDWAY_HEIGHT = new Prop<>("node.speedway.startBlock", -1);
    public static final Prop<Integer> SMART_TOKEN_HEIGHT = new Prop<>("node.smartToken.startBlock", -1);
    public static final Prop<Integer> SMART_FEES_HEIGHT = new Prop<>("node.smartFees.startBlock", -1);
    public static final Prop<Integer> SMART_ATS_HEIGHT = new Prop<>("node.smartAts.startBlock", -1);
    public static final Prop<Integer> DISTRIBUTION_FIX_BLOCK_HEIGHT = new Prop<>("node.distributionFix.startBlock", -1);
    public static final Prop<Integer> AT_FIX_BLOCK_5_BLOCK_HEIGHT = new Prop<>("node.atFixBlock5.startBlock", -1);

    public static final Prop<Integer> PK_BLOCK_HEIGHT = new Prop<>("node.pkBlock.startBlock", -1);
    public static final Prop<Integer> PK2_BLOCK_HEIGHT = new Prop<>("node.pk2Block.startBlock", -1);
    public static final Prop<Integer> PK_BLOCKS_PAST = new Prop<>("node.pkBlocksPast", 131400);
    public static final Prop<Boolean> PK_API_BLOCK = new Prop<>("node.pkAPIBlock", true);
    public static final Prop<Integer> SMART_ALIASES_HEIGHT = new Prop<>("node.smartAliases.startBlock", -1);

    public static final Prop<Integer> DEV_NEXT_FORK_BLOCK_HEIGHT = new Prop<>("DEV.nextFork.startBlock", -1);

    public static final Prop<Boolean> NODE_DEBUG_TRACE_ENABLED = new Prop<>("node.debugTraceEnable", false);
    public static final Prop<String> NODE_DEBUG_TRACE_QUOTE = new Prop<>("node.debugTraceQuote", "\"");
    public static final Prop<String> NODE_DEBUG_TRACE_SEPARATOR = new Prop<>("node.debugTraceSeparator", "\t");
    public static final Prop<Boolean> NODE_DEBUG_LOG_CONFIRMED = new Prop<>("node.debugLogUnconfirmed", false);
    public static final Prop<String> NODE_DEBUG_TRACE_ACCOUNTS = new Prop<>("node.debugTraceAccounts", "");

    public static final Prop<String> NODE_DEBUG_TRACE_LOG = new Prop<>("node.debugTraceLog",
            "LOG_AccountBalances_trace.csv");
    public static final Prop<Integer> NODE_COMMUNICATION_LOGGING_MASK = new Prop<>("node.communicationLoggingMask", 0);

    public static final Prop<Integer> NODE_SHUTDOWN_TIMEOUT = new Prop<>("node.shutdownTimeout", 180);
    ...
    public static final Prop<String> NODE_CHECKPOINT_HASH = new Prop<>("node.checkPointPrevHash",
            "8f76beca852b41447ac59fbdf78750e43dde97f9fc09ec8f071eeb03c43420f0");
    public static final Prop<String> NODE_PK_CHECKS = new Prop<>("node.pkChecks",
    ...
    public static final Prop<Boolean> NODE_TEST_UNCONFIRMED_TRANSACTIONS = new Prop<>(
            "node.testUnconfirmedTransactions",
            false);
    ...
    public static final Prop<Integer> NODE_AT_PROCESSOR_CACHE_BLOCK_COUNT = new Prop<>(
            "node.atProcessorCacheBlockCount",
            1000);
    ...
    public static final Prop<Integer> P2P_BLACKLISTING_TIME_MS = new Prop<>("P2P.BlacklistingTime_ms", 6000000);
    ...
    public static final Prop<Boolean> INITIAL_POP_OFF_ENABLED = new Prop<>("node.initialPopOff.enable", true);
