...
import static application.module.node.web.api.http.common.JSONResponses.INCORRECT_ASSET_NAME;
import static application.module.node.web.api.http.common.JSONResponses.MISSING_NAME;
...
public final class GetAssetsByName extends AbstractAssetsRetrieval {
    ...
    public GetAssetsByName(AssetExchange assetExchange, AccountService accountService, Blockchain blockchain) {
