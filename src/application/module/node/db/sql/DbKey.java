...
public interface DbKey extends SignumKey {
    ...
    abstract class LinkKey3Factory<T> extends Factory<T> implements SignumKey.LinkKey3Factory<T> {
        ...
        @Override
        public DbKey newKey(Record rs) {
            return new LinkKey3(rs.get(idColumnA, Long.class), rs.get(idColumnB, Long.class),
                    rs.get(idColumnC, Long.class), idColumnA, idColumnB, idColumnC);
        }
    ...
    final class LinkKey3 implements DbKey {
        ...
        @Override
        public boolean equals(Object o) {
            return o instanceof LinkKey3 && ((LinkKey3) o).idA == idA && ((LinkKey3) o).idB == idB
                    && ((LinkKey3) o).idC == idC;
        }
