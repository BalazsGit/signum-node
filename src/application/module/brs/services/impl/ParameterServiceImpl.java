...
public class ParameterServiceImpl implements ParameterService {
    ...
    public Account getAccount(HttpServletRequest req, boolean checkPresent) throws SignumException {
        ...
        try {
            ...
            if (accountAddress.getPublicKey() != null && account.getPublicKey() != null
    ...
    public DigitalGoodsStore.Purchase getPurchase(HttpServletRequest req) throws ParameterException {
        ...
        try {
            DigitalGoodsStore.Purchase purchase = dgsGoodsStoreService
                    .getPurchase(Convert.parseUnsignedLong(purchaseIdString));
            if (purchase == null) {
    ...
    @Override
    public EncryptedData getEncryptedMessage(HttpServletRequest req, Account recipientAccount, byte[] publicKey)
