...
public class Asset extends TableImpl<AssetRecord> {
     ...
     */
    public final TableField<AssetRecord, Long> DB_ID = createField(DSL.name("db_id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.asset.id</code>.
     */
    public final TableField<AssetRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false),
            this, "");

    /**
     * The column <code>DB.asset.account_id</code>.
     */
    public final TableField<AssetRecord, Long> ACCOUNT_ID = createField(DSL.name("account_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.asset.name</code>.
     */
    public final TableField<AssetRecord, String> NAME = createField(DSL.name("name"),
            SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>DB.asset.description</code>.
     */
    public final TableField<AssetRecord, String> DESCRIPTION = createField(DSL.name("description"),
            SQLDataType.CLOB.defaultValue(DSL.field("NULL", SQLDataType.CLOB)), this, "");

    /**
     * The column <code>DB.asset.quantity</code>.
     */
    public final TableField<AssetRecord, Long> QUANTITY = createField(DSL.name("quantity"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.asset.decimals</code>.
     */
    public final TableField<AssetRecord, Byte> DECIMALS = createField(DSL.name("decimals"),
            SQLDataType.TINYINT.nullable(false), this, "");

    /**
     * The column <code>DB.asset.height</code>.
     */
    public final TableField<AssetRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.asset.mintable</code>.
     */
    public final TableField<AssetRecord, Boolean> MINTABLE = createField(DSL.name("mintable"),
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.ASSET_ASSET_ACCOUNT_ID_IDX, Indexes.ASSET_ASSET_HEIGHT_IDX);
    }
