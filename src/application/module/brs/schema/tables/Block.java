...
public class Block extends TableImpl<BlockRecord> {
     ...
     */
    public final TableField<BlockRecord, Long> DB_ID = createField(DSL.name("db_id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.block.id</code>.
     */
    public final TableField<BlockRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false),
            this, "");

    /**
     * The column <code>DB.block.version</code>.
     */
    public final TableField<BlockRecord, Integer> VERSION = createField(DSL.name("version"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.block.timestamp</code>.
     */
    public final TableField<BlockRecord, Integer> TIMESTAMP = createField(DSL.name("timestamp"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.block.previous_block_id</code>.
     */
    public final TableField<BlockRecord, Long> PREVIOUS_BLOCK_ID = createField(DSL.name("previous_block_id"),
            SQLDataType.BIGINT.defaultValue(DSL.field("NULL", SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>DB.block.total_amount</code>.
     */
    public final TableField<BlockRecord, Long> TOTAL_AMOUNT = createField(DSL.name("total_amount"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.block.total_fee</code>.
     */
    public final TableField<BlockRecord, Long> TOTAL_FEE = createField(DSL.name("total_fee"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.block.payload_length</code>.
     */
    public final TableField<BlockRecord, Integer> PAYLOAD_LENGTH = createField(DSL.name("payload_length"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.block.generator_public_key</code>.
     */
    public final TableField<BlockRecord, byte[]> GENERATOR_PUBLIC_KEY = createField(DSL.name("generator_public_key"),
            SQLDataType.VARBINARY(32).nullable(false), this, "");

    /**
     * The column <code>DB.block.previous_block_hash</code>.
     */
    public final TableField<BlockRecord, byte[]> PREVIOUS_BLOCK_HASH = createField(DSL.name("previous_block_hash"),
     ...
     */
    public final TableField<BlockRecord, byte[]> CUMULATIVE_DIFFICULTY = createField(DSL.name("cumulative_difficulty"),
            SQLDataType.BLOB.nullable(false), this, "");

    /**
     * The column <code>DB.block.base_target</code>.
     */
    public final TableField<BlockRecord, Long> BASE_TARGET = createField(DSL.name("base_target"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.block.next_block_id</code>.
     */
    public final TableField<BlockRecord, Long> NEXT_BLOCK_ID = createField(DSL.name("next_block_id"),
            SQLDataType.BIGINT.defaultValue(DSL.field("NULL", SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>DB.block.height</code>.
     */
    public final TableField<BlockRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.block.generation_signature</code>.
     */
    public final TableField<BlockRecord, byte[]> GENERATION_SIGNATURE = createField(DSL.name("generation_signature"),
            SQLDataType.VARBINARY(64).nullable(false), this, "");

    /**
     * The column <code>DB.block.block_signature</code>.
     */
    public final TableField<BlockRecord, byte[]> BLOCK_SIGNATURE = createField(DSL.name("block_signature"),
            SQLDataType.VARBINARY(64).nullable(false), this, "");

    /**
     * The column <code>DB.block.payload_hash</code>.
     */
    public final TableField<BlockRecord, byte[]> PAYLOAD_HASH = createField(DSL.name("payload_hash"),
            SQLDataType.VARBINARY(32).nullable(false), this, "");

    /**
     * The column <code>DB.block.generator_id</code>.
     */
    public final TableField<BlockRecord, Long> GENERATOR_ID = createField(DSL.name("generator_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.block.nonce</code>.
     */
    public final TableField<BlockRecord, Long> NONCE = createField(DSL.name("nonce"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.block.ats</code>.
     */
    public final TableField<BlockRecord, byte[]> ATS = createField(DSL.name("ats"),
            SQLDataType.BLOB.defaultValue(DSL.field("NULL", SQLDataType.BLOB)), this, "");

    /**
     * The column <code>DB.block.total_fee_cash_back</code>.
     */
    public final TableField<BlockRecord, Long> TOTAL_FEE_CASH_BACK = createField(DSL.name("total_fee_cash_back"),
            SQLDataType.BIGINT.defaultValue(DSL.field("0", SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>DB.block.total_fee_burnt</code>.
     */
    public final TableField<BlockRecord, Long> TOTAL_FEE_BURNT = createField(DSL.name("total_fee_burnt"),
            SQLDataType.BIGINT.defaultValue(DSL.field("0", SQLDataType.BIGINT)), this, "");
    ...
    public List<UniqueKey<BlockRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_BLOCK_BLOCK_ID_IDX, Keys.KEY_BLOCK_BLOCK_TIMESTAMP_IDX,
