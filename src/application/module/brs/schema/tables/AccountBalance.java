...
public class AccountBalance extends TableImpl<AccountBalanceRecord> {
     ...
     */
    public final TableField<AccountBalanceRecord, Long> DB_ID = createField(DSL.name("db_id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.account_balance.id</code>.
     */
    public final TableField<AccountBalanceRecord, Long> ID = createField(DSL.name("id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.account_balance.balance</code>.
     */
    public final TableField<AccountBalanceRecord, Long> BALANCE = createField(DSL.name("balance"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.account_balance.unconfirmed_balance</code>.
     */
    public final TableField<AccountBalanceRecord, Long> UNCONFIRMED_BALANCE = createField(
            DSL.name("unconfirmed_balance"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.account_balance.forged_balance</code>.
     */
    public final TableField<AccountBalanceRecord, Long> FORGED_BALANCE = createField(DSL.name("forged_balance"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.account_balance.height</code>.
     */
    public final TableField<AccountBalanceRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.account_balance.latest</code>.
     */
    public final TableField<AccountBalanceRecord, Boolean> LATEST = createField(DSL.name("latest"),
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.ACCOUNT_BALANCE_ACCOUNT_BALANCE_HEIGHT_IDX,
                Indexes.ACCOUNT_BALANCE_ACCOUNT_BALANCE_ID_LATEST_IDX);
    }
