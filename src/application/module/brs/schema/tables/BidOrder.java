...
public class BidOrder extends TableImpl<BidOrderRecord> {
     ...
     */
    public final TableField<BidOrderRecord, Long> DB_ID = createField(DSL.name("db_id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.bid_order.id</code>.
     */
    public final TableField<BidOrderRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false),
            this, "");

    /**
     * The column <code>DB.bid_order.account_id</code>.
     */
    public final TableField<BidOrderRecord, Long> ACCOUNT_ID = createField(DSL.name("account_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.bid_order.asset_id</code>.
     */
    public final TableField<BidOrderRecord, Long> ASSET_ID = createField(DSL.name("asset_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.bid_order.price</code>.
     */
    public final TableField<BidOrderRecord, Long> PRICE = createField(DSL.name("price"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.bid_order.quantity</code>.
     */
    public final TableField<BidOrderRecord, Long> QUANTITY = createField(DSL.name("quantity"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.bid_order.creation_height</code>.
     */
    public final TableField<BidOrderRecord, Integer> CREATION_HEIGHT = createField(DSL.name("creation_height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.bid_order.height</code>.
     */
    public final TableField<BidOrderRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.bid_order.latest</code>.
     */
    public final TableField<BidOrderRecord, Boolean> LATEST = createField(DSL.name("latest"),
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.BID_ORDER_BID_ORDER_ACCOUNT_ID_IDX, Indexes.BID_ORDER_BID_ORDER_ASSET_ID_PRICE_IDX,
                Indexes.BID_ORDER_BID_ORDER_CREATION_IDX, Indexes.BID_ORDER_BID_ORDER_HEIGHT_IDX);
    }
