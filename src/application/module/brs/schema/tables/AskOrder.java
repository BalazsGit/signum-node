...
public class AskOrder extends TableImpl<AskOrderRecord> {
     ...
     */
    public final TableField<AskOrderRecord, Long> DB_ID = createField(DSL.name("db_id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.ask_order.id</code>.
     */
    public final TableField<AskOrderRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false),
            this, "");

    /**
     * The column <code>DB.ask_order.account_id</code>.
     */
    public final TableField<AskOrderRecord, Long> ACCOUNT_ID = createField(DSL.name("account_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.ask_order.asset_id</code>.
     */
    public final TableField<AskOrderRecord, Long> ASSET_ID = createField(DSL.name("asset_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.ask_order.price</code>.
     */
    public final TableField<AskOrderRecord, Long> PRICE = createField(DSL.name("price"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.ask_order.quantity</code>.
     */
    public final TableField<AskOrderRecord, Long> QUANTITY = createField(DSL.name("quantity"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.ask_order.creation_height</code>.
     */
    public final TableField<AskOrderRecord, Integer> CREATION_HEIGHT = createField(DSL.name("creation_height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.ask_order.height</code>.
     */
    public final TableField<AskOrderRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.ask_order.latest</code>.
     */
    public final TableField<AskOrderRecord, Boolean> LATEST = createField(DSL.name("latest"),
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.ASK_ORDER_ASK_ORDER_ACCOUNT_ID_IDX, Indexes.ASK_ORDER_ASK_ORDER_ASSET_ID_PRICE_IDX,
                Indexes.ASK_ORDER_ASK_ORDER_CREATION_IDX, Indexes.ASK_ORDER_ASK_ORDER_HEIGHT_IDX);
    }
