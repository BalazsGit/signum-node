...
public class AssetTransfer extends TableImpl<AssetTransferRecord> {
     ...
     */
    public final TableField<AssetTransferRecord, Long> DB_ID = createField(DSL.name("db_id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.asset_transfer.id</code>.
     */
    public final TableField<AssetTransferRecord, Long> ID = createField(DSL.name("id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.asset_transfer.asset_id</code>.
     */
    public final TableField<AssetTransferRecord, Long> ASSET_ID = createField(DSL.name("asset_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.asset_transfer.sender_id</code>.
     */
    public final TableField<AssetTransferRecord, Long> SENDER_ID = createField(DSL.name("sender_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.asset_transfer.recipient_id</code>.
     */
    public final TableField<AssetTransferRecord, Long> RECIPIENT_ID = createField(DSL.name("recipient_id"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.asset_transfer.quantity</code>.
     */
    public final TableField<AssetTransferRecord, Long> QUANTITY = createField(DSL.name("quantity"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.asset_transfer.timestamp</code>.
     */
    public final TableField<AssetTransferRecord, Integer> TIMESTAMP = createField(DSL.name("timestamp"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.asset_transfer.height</code>.
     */
    public final TableField<AssetTransferRecord, Integer> HEIGHT = createField(DSL.name("height"),
            SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.ASSET_TRANSFER_ASSET_TRANSFER_ASSET_ID_IDX,
                Indexes.ASSET_TRANSFER_ASSET_TRANSFER_HEIGHT_IDX, Indexes.ASSET_TRANSFER_ASSET_TRANSFER_ID_IDX,
