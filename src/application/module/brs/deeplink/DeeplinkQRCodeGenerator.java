package application.module.brs.deeplink;
...
public class DeeplinkQRCodeGenerator {
    ...
    public BufferedImage generateRequestSignumDeepLinkQRCode(String receiverId, long amountNQT,
            FeeSuggestionType feeSuggestionType, Long feeNQT, String message, boolean immutable)
    ...
    private BufferedImage generateSignumQRCode(String url) throws WriterException {
        return MatrixToImageWriter.toBufferedImage(qrCodeWriter.encode(url, BarcodeFormat.QR_CODE, 350, 350, hints),
