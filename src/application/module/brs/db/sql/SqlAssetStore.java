...
import application.module.brs.db.store.AssetStore;
import application.module.brs.db.store.DerivedTableManager;
import application.module.brs.schema.tables.records.AssetRecord;
...
import static application.module.brs.schema.Tables.ASSET;
...
public class SqlAssetStore implements AssetStore {
    ...
    public SqlAssetStore(DerivedTableManager derivedTableManager) {
        assetTable = new EntitySqlTable<Asset>("asset", application.module.brs.schema.Tables.ASSET, assetDbKeyFactory,
                derivedTableManager) {
