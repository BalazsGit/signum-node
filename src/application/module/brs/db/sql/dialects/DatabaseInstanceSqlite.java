package application.module.brs.db.sql.dialects;
...
public class DatabaseInstanceSqlite extends DatabaseInstanceBaseImpl {
    ...
    private String getSynchronousMode() {
        ...
        switch (synchronous) {
            ...
            case "OFF":
                logger.warn(
                        "SQLite synchronous mode set to: OFF. This could result in a database corruption, when the operating system crashes or the computer loses power!");
                return "OFF";
            default:
                return "NORMAL";
        }
