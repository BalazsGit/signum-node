...
public class Subnet {
     ...
     * 
     * @param subnetAddress java.net.InetAddress (IP address)
     * @param mask          java.net.InetAddress (IP address, here used as network
     *                      mask)
     */
    private Subnet(final InetAddress subnetAddress, final InetAddress mask) {
        ...
        this.bigMask = null == mask ? BigInteger.valueOf(-1) : new BigInteger(mask.getAddress()); // no mask given case
                                                                                                  // is handled here.
        this.bigSubnetMasked = new BigInteger(subnetAddress.getAddress()).and(this.bigMask);
    }
