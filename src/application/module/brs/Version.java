...
public final class Version {
    ...
    public static Version parse(String version) {
        ...
        try {
            ...
            if (tokenizer.hasMoreTokens()) {
                ...
                int prereleaseIteration = prereleaseTagAndIteration.length == 2
    ...
    public boolean isGreaterThan(Version otherVersion) {
        ...
        if (patch < otherVersion.patch)
            return false;
        if (prereleaseTag.priority > otherVersion.prereleaseTag.priority)
            return true;
        if (prereleaseTag.priority < otherVersion.prereleaseTag.priority)
            return false;
    ...
    public boolean equals(Object o) {
        ...
        if (patch != version.patch)
            return false;
        if (prereleaseIteration != version.prereleaseIteration)
            return false;
