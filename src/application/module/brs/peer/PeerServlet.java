...
import static application.module.brs.Constants.PROTOCOL;
...
import application.module.brs.util.CountingInputStream;
import application.module.brs.util.CountingOutputStream;
            ...
            if (request.get(PROTOCOL) != null
                ...
                if (logger.isDebugEnabled()) {
                    logger.debug(
                            ...
                            JSON.getAsString(request.get(PROTOCOL)));
                }
