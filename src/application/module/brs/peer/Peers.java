...
import static application.module.brs.peer.Peer.isHigherOrEqualVersion;
import static application.module.brs.props.Props.P2P_ENABLE_TX_REBROADCAST;
import static application.module.brs.props.Props.P2P_SEND_TO_LIMIT;
import static application.module.brs.util.JSON.prepareRequest;
...
public final class Peers {
    ...
    private static final AtomicBoolean connectWellKnownFinished = new AtomicBoolean(false);
