...
import application.module.brs.Attachment.ColoredCoinsAskOrderPlacement;
import application.module.brs.Attachment.ColoredCoinsAssetIssuance;
import application.module.brs.Attachment.ColoredCoinsBidOrderPlacement;
...
import application.module.brs.Trade.Event;
...
public class AssetExchangeImpl implements AssetExchange {
    ...
    public CollectionWithIndex<Trade> getAccountAssetTrades(long accountId, long assetId, int from, int to) {
        return new CollectionWithIndex<Trade>(tradeService.getAccountAssetTrades(accountId, assetId, from, to), from,
                to);
    }
    ...
    @Override
    public CollectionWithIndex<AccountAsset> getAssetAccounts(Asset asset, boolean ignoreTreasury, long minimumQuantity,
            boolean unconfirmed, int from, int to) {
        return new CollectionWithIndex<AccountAsset>(
                assetAccountService.getAssetAccounts(asset, ignoreTreasury, minimumQuantity, unconfirmed, from, to),
                from, to);
    }
    ...
    public CollectionWithIndex<AssetTransfer> getAssetTransfers(long assetId, int from, int to) {
        return new CollectionWithIndex<AssetTransfer>(assetTransferService.getAssetTransfers(assetId, from, to), from,
                to);
    }

    @Override
    public CollectionWithIndex<AssetTransfer> getAccountAssetTransfers(long accountId, long assetId, int from, int to) {
        return new CollectionWithIndex<AssetTransfer>(
                assetTransferService.getAccountAssetTransfers(accountId, assetId, from, to), from, to);
    }
