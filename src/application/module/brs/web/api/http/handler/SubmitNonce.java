...
public final class SubmitNonce extends ApiServlet.JsonRequestHandler {
    ...
    public SubmitNonce(PropertyService propertyService, AccountService accountService, Blockchain blockchain,
            Generator generator) {
        super(new LegacyDocTag[] { LegacyDocTag.MINING }, SECRET_PHRASE_PARAMETER, NONCE_PARAMETER,
                ACCOUNT_ID_PARAMETER, BLOCK_HEIGHT_PARAMETER, DEADLINE_PARAMETER);
        ...
        this.passphrases = propertyService.getStringList(Props.SOLO_MINING_PASSPHRASES)
                ...
                .collect(Collectors.toMap(
                        passphrase -> signumCrypto.getAddressFromPassphrase(passphrase).getSignedLongId(),
                        Function.identity()));
    ...
    public static void verifySecretAccount(AccountService accountService, Blockchain blockchain, Account secretAccount,
