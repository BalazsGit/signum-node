...
abstract class AbstractAssetsRetrieval extends ApiServlet.JsonRequestHandler {
    ...
    AbstractAssetsRetrieval(LegacyDocTag[] legacyDocTags, AssetExchange assetExchange, AccountService accountService,
            String... parameters) {
    ...
    JsonArray assetsToJson(Iterator<Asset> assets, int heightStart, int heightEnd, boolean skipZeroVolume) {
        ...
        while (assets.hasNext()) {
            ...
            assetsJsonArray.add(JSONData.asset(asset, accountService.getAccount(asset.getAccountId()), quantityBurnt,
                    tradeCount, transferCount, accountsCount, circulatingSupply,
