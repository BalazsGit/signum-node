...
import static application.module.brs.web.api.http.common.JSONResponses.ERROR_NOT_ALLOWED;
import static application.module.brs.web.api.http.common.Parameters.API_KEY_PARAMETER;
import static application.module.brs.web.api.http.common.Parameters.HEIGHT_PARAMETER;
import static application.module.brs.web.api.http.common.Parameters.NUM_BLOCKS_PARAMETER;
import static application.module.brs.web.api.http.common.ResultFields.BLOCKS_RESPONSE;
import static application.module.brs.web.api.http.common.ResultFields.ERROR_RESPONSE;
