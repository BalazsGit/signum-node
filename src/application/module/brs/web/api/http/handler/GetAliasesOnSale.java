...
import static application.module.brs.web.api.http.common.ResultFields.ALIASES_RESPONSE;
...
public final class GetAliasesOnSale extends ApiServlet.JsonRequestHandler {
    ...
    public GetAliasesOnSale(AliasService aliasService) {
        super(new LegacyDocTag[] { LegacyDocTag.ALIASES }, ACCOUNT_PARAMETER, BUYER_PARAMETER, FIRST_INDEX_PARAMETER,
    ...
    protected JsonElement processRequest(HttpServletRequest req) throws SignumException {
        ...
        CollectionWithIndex<Alias.Offer> aliasOffers = aliasService.getAliasOffers(account, buyer, firstIndex,
                lastIndex);
