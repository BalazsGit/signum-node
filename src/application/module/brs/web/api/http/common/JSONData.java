...
import application.module.brs.db.sql.SqlTransactionDb;
...
public final class JSONData {
    ...
    public static JsonObject asset(Asset asset, Account issuerAccount, long quantityBurnt, int tradeCount,
            int transferCount, int assetAccountsCount, long circulatingSupply,
    ...
    public static JsonObject order(Order order, Asset asset) {
        ...
        if (asset != null) {
            json.addProperty(NAME_RESPONSE, asset.getName());
            json.addProperty(DECIMALS_RESPONSE, asset.getDecimals());
            json.addProperty(PRICE_RESPONSE,
                    String.valueOf(order.getPriceNQT() * PRICE_MULTIPLIER[asset.getDecimals()]));
        }
        return json;
    }
    ...
    public static JsonObject trade(Trade trade, Asset asset) {
        ...
        if (asset != null) {
            ...
            json.addProperty(DECIMALS_RESPONSE, asset.getDecimals());
            json.addProperty(PRICE_RESPONSE,
                    String.valueOf(trade.getPriceNQT() * PRICE_MULTIPLIER[asset.getDecimals()]));
        }
        return json;
    }
