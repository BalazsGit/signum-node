...
import application.module.brs.Constants;
...
public final class JSONResponses {
    ...
    public static final JsonElement INCORRECT_ALIAS_LENGTH = incorrect(ALIAS_PARAMETER,
            "(length must be in [1.." + Constants.MAX_ALIAS_LENGTH + "] range)");
    public static final JsonElement INCORRECT_ALIAS_NAME = incorrect(ALIAS_PARAMETER,
            "(must contain only digits and latin letters)");
    public static final JsonElement INCORRECT_ALIAS_NOTFORSALE = incorrect(ALIAS_PARAMETER,
            "(alias is not for sale at the moment)");
    public static final JsonElement INCORRECT_URI_LENGTH = incorrect(URI_PARAMETER,
    ...
    public static final JsonElement MISSING_TRANSACTION_BYTES_OR_JSON = missing(TRANSACTION_BYTES_PARAMETER,
    ...
    public static final JsonElement INCORRECT_ASSET_DESCRIPTION = incorrect(DESCRIPTION_PARAMETER,
            "(length must not exceed " + Constants.MAX_ASSET_DESCRIPTION_LENGTH + " characters)");
    public static final JsonElement INCORRECT_ASSET_NAME = incorrect(NAME_PARAMETER,
            "(must contain only digits and latin letters)");
    public static final JsonElement INCORRECT_ASSET_NAME_LENGTH = incorrect(NAME_PARAMETER, "(length must be in ["
            + Constants.MIN_ASSET_NAME_LENGTH + ".." + Constants.MAX_ASSET_NAME_LENGTH + "] range)");
    ...
    public static final JsonElement INCORRECT_ASSET_QUANTITY = incorrect(QUANTITY_PARAMETER,
            "(must be in [0.." + Constants.MAX_ASSET_QUANTITY_QNT + "] range)");
    ...
    public static final JsonElement INCORRECT_REFERENCED_TRANSACTION = incorrect(
    ...
    public static final JsonElement INCORRECT_ACCOUNT_NAME_LENGTH = incorrect(NAME_PARAMETER,
            "(length must be less than " + Constants.MAX_ACCOUNT_NAME_LENGTH + " characters)");
    public static final JsonElement INCORRECT_ACCOUNT_DESCRIPTION_LENGTH = incorrect(DESCRIPTION_PARAMETER,
    ...
    public static final JsonElement INCORRECT_PERIOD = incorrect(PERIOD_PARAMETER,
            "(period must be at least 1440 blocks)");
    ...
    public static final JsonElement INCORRECT_DGS_LISTING_NAME = incorrect(NAME_PARAMETER,
            "(length must be not longer than " + Constants.MAX_DGS_LISTING_NAME_LENGTH + " characters)");
    public static final JsonElement INCORRECT_DGS_LISTING_DESCRIPTION = incorrect(DESCRIPTION_PARAMETER,
            "(length must be not longer than " + Constants.MAX_DGS_LISTING_DESCRIPTION_LENGTH + " characters)");
    public static final JsonElement INCORRECT_DGS_LISTING_TAGS = incorrect(TAGS_PARAMETER,
    ...
    public static final JsonElement MISSING_DELIVERY_DEADLINE_TIMESTAMP = missing(
            DELIVERY_DEADLINE_TIMESTAMP_PARAMETER);
    public static final JsonElement INCORRECT_DELIVERY_DEADLINE_TIMESTAMP = incorrect(
            DELIVERY_DEADLINE_TIMESTAMP_PARAMETER);
    public static final JsonElement INCORRECT_PURCHASE_QUANTITY = incorrect(QUANTITY_PARAMETER,
            "(quantity exceeds available goods quantity)");
    public static final JsonElement INCORRECT_PURCHASE_PRICE = incorrect(PRICE_NQT_PARAMETER,
            "(purchase price doesn't match goods price)");
    ...
    public static final JsonElement MISSING_SECRET_PHRASE_OR_PUBLIC_KEY = missing(SECRET_PHRASE_PARAMETER,
    ...
    public static final JsonElement INCORRECT_AUTOMATED_TRANSACTION_NAME_LENGTH = incorrect(DESCRIPTION_PARAMETER,
            "(length must not exceed " + Constants.MAX_AUTOMATED_TRANSACTION_NAME_LENGTH + " characters)");
    public static final JsonElement INCORRECT_AUTOMATED_TRANSACTION_NAME = incorrect(NAME_PARAMETER,
            "(must contain only digits and latin letters)");
    public static final JsonElement INCORRECT_AUTOMATED_TRANSACTION_DESCRIPTION = incorrect(DESCRIPTION_PARAMETER,
    ...
    public static final JsonElement PAYLOAD_WITHOUT_ACTION = incorrect(PAYLOAD_PARAMETER,
            "With 'payload' parameter the 'action' parameter is mandatory");

    public static final JsonElement FEE_OR_FEE_SUGGESTION_REQUIRED = incorrect(FEE_SUGGESTION_TYPE_PARAMETER,
            "Either feeNQT or feeSuggestionType is a required parameter");
    public static final JsonElement FEE_SUGGESTION_TYPE_INVALID = incorrect(FEE_SUGGESTION_TYPE_PARAMETER,
            "feeSuggestionType is not valid");
    public static final JsonElement INCORRECT_MESSAGE_LENGTH = incorrect(MESSAGE_PARAMETER,
