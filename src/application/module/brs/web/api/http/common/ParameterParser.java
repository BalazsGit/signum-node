...
public final class ParameterParser {
    ...
    public static long getOrderId(HttpServletRequest req) throws ParameterException {
    ...
    public static EncryptedData getEncryptedGoods(HttpServletRequest req) throws ParameterException {
    ...
    public static String getSecretPhrase(HttpServletRequest req) throws ParameterException {
    ...
    public static String getRecipientPublicKey(HttpServletRequest req) throws ParameterException {
    ...
    public static long getSellerId(HttpServletRequest req) throws ParameterException {
    ...
    public static long getBuyerId(HttpServletRequest req) throws ParameterException {
    ...
    public static byte[] getByteArray(HttpServletRequest req, String param, boolean checkMissing)
    ...
    public static String getString(HttpServletRequest req, String param, boolean checkMissing)
            throws ParameterException {
        String stringValue = req.getParameter(param);
        if (stringValue == null && checkMissing) {
            throw new ParameterException(JSONResponses.missing(param));
