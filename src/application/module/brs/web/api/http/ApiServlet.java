...
import application.module.brs.web.api.http.handler.*;
...
public final class ApiServlet extends HttpServlet {
    ...
    private Map<String, HttpRequestHandler> mapRequestHandlers() {
        ...
        map.put("getUnconfirmedTransactionIds",
                new GetUnconfirmedTransactionIds(transactionProcessor, indirectIncomingService, parameterService));
        map.put("getUnconfirmedTransactions",
                new GetUnconfirmedTransactions(transactionProcessor, indirectIncomingService, parameterService));
        ...
        map.put("clearUnconfirmedTransactions",
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            if (!acceptSurplusParams)
                apiRequestHandler.validateParams(req);
