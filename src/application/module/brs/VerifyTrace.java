    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(fileName))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                Map<String, Map<String, Long>> accountAssetMap = accountAssetTotals.computeIfAbsent(accountId,
                        k -> new HashMap<>());
            ...
            for (Map.Entry<String, Map<String, Long>> mapEntry : totals.entrySet()) {
                ...
                balanceHeaders.forEach(balanceHeader -> System.out
                        .println(balanceHeader + ": " + nullToZero(accountValues.get(balanceHeader))));
