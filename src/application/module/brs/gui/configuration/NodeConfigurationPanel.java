...
import application.module.brs.gui.configuration.databaseConfiguration.DatabaseConfigurationPanel;
import application.module.brs.gui.configuration.databaseConfiguration.DatabaseConfigurationUtils;
import application.module.brs.util.Convert;
import application.module.brs.util.PathUtils;
import application.module.brs.gui.GuiColors;
import application.module.brs.gui.GuiConstants;
...
public class NodeConfigurationPanel extends JPanel {
    ...
    private void updateUIFromProperties(Properties props) {
        for (Map.Entry<String, JComponent> entry : propertyComponents.entrySet()) {
            ...
            if (comp instanceof JPanel && Props.BRS_PK_CHECKS.getName().equals(key)) {
    ...
    public void loadAppliedProperties() {
        application.module.brs.props.PropertyService service = application.module.brs.Signum.getPropertyService();
        if (service == null)
            return;
    ...
    private String getServiceValueAsString(application.module.brs.props.PropertyService service, Prop prop) {
