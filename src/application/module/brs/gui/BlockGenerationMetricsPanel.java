...
import application.module.brs.gui.util.ContextMenuUtils;
import application.module.brs.gui.util.CustomDrawingIcon;
import application.module.brs.gui.util.MovingAverage;
import application.module.brs.gui.util.TableUtils;
...
public class BlockGenerationMetricsPanel extends JPanel {
    ...
    private static class MinerPieToolTipGenerator implements PieToolTipGenerator {
        ...
        public String generateToolTip(PieDataset dataset, Comparable key) {
            ...
            try {
                ...
                application.module.brs.Account account = application.module.brs.Account.getAccount(generatorId);
    ...
    static class MinerEntry implements Comparable<MinerEntry> {
        ...
        MinerEntry(long accountId, BigInteger deadline, Type type, int height, long timestamp, long blockId) {
            ...
            application.module.brs.Account account = application.module.brs.Account.getAccount(accountId);
