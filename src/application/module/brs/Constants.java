...
public final class Constants {
    ...
    // not sure when these were enabled, but they each do an alias lookup every
    // block if greater than the current height
    ...
    public static final int TRIM_PERIOD = MAX_ROLLBACK * 10;
    ...
    public static final int EC_RULE_TERMINATOR = 2400; /*
                                                        * cfb: This constant defines a straight edge when
                                                        * "longest chain"
