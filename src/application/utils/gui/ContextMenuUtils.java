...
public final class ContextMenuUtils {
    ...
    public static void buildProfileMenu(JPopupMenu popup, AppearancePanel appearancePanel) {
        // Profile Info
        JComboBox<String> profileComboBox = appearancePanel.getProfileComboBox();
        ...
        if (profileComboBox.getItemCount() == 0) {
            ...
            for (int i = 0; i < profileComboBox.getItemCount(); i++) {
                ...
                profileItem.addActionListener(ae -> appearancePanel.loadProfile(profileName));
        ...
        saveItem.addActionListener(ae -> appearancePanel.saveProfile());
        popup.add(saveItem);
        ...
        renameItem.addActionListener(ae -> appearancePanel.renameProfile(currentProfile));
    ...
    public static void showColorChooserDialog(Component parent, String key) {
        ...
        ColorSettingsPanel colorSettingsPanel = appearancePanel.getColorSettingsPanel();
