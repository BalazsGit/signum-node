...
```
Presentation Layer  (application.module.node.web.api.http.handler) 
    ↓
Business Logic Layer  (application.module.node.services.impl)
    ↓  
Data Access Layer  (application.module.node.db.store)
    ↓
